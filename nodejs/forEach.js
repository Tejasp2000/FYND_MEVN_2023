...
console.log(fruits);
console.log(findFruit('banana'));// error?
...
ages.sort ();//ascending
ages. reverse() ;//desecnd ing after asc in the previous line
...
const cars=["btw","mercedes"];

const car={type:"flat",model:"400",color:"white"};// name:value pairs
// use this while matching tha data to the documents of mango